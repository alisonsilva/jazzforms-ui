...
public class TextfieldFormController implements Initializable, IControllerComponent{

	@FXML private HBox textFieldFormPane;

	private CustomTextfieldForm custTextField;	
	
	@Override
	public void initialize(URL url, ResourceBundle resBundle) {
		custTextField = new CustomTextfieldForm();
		custTextField.setId(CustomTextfieldForm.UI_COMPONENT_ID);
		custTextField.getStyleClass().add(CustomTextfieldForm.UNFOCUSED_STYLE_NAME);
