...
public class ToolBarController implements Initializable, IControllerComponent{

	@FXML private BorderPane titleBar;
	private CustomToolBar barra;
	
	
	@Override
	public void initialize(URL url, ResourceBundle resBundle) {
		barra = new CustomToolBar();
		barra.setId(CustomToolBar.UI_COMPONENT_ID);
