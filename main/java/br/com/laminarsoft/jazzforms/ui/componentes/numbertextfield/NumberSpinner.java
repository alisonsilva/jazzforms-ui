package br.com.laminarsoft.jazzforms.ui.componentes.numbertextfield;
...
public class NumberSpinner extends HBox {
    ...
    private ObjectProperty<BigDecimal> stepWitdhProperty = new SimpleObjectProperty<BigDecimal>();
    ...
    private void decrement() {
        ...
        if (onlyPositive && value.doubleValue() < 0) {
        	numberField.setNumber(BigDecimal.ZERO);
        } else {
	        numberField.setNumber(value);
        }
    }
    ...
    public final NumberTextField getNumberField(){
    	return numberField;
    }
    
    public final void setTooltiptext(String value) {
    	numberField.setTooltiptext(value);
    }
    
    public ObjectProperty<String> tooltiptextProperty() {
    	return numberField.tooltiptextProperty();
    }
    
    public final String getTooltiptext() {
    	return numberField.getTooltiptext();
    }
