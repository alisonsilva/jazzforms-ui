...
public class HTMLCodeEditor extends StackPane {
...
*/
	...
	private final String editingTemplate = "<!doctype html>"
			...
			+ "  <script src=\"" + PropertiesServiceController.getInstance().getProperty("url.base") + "/estatico/htmlembedded.js\"></script>"
			+ "  <script src=\"" + PropertiesServiceController.getInstance().getProperty("url.base") + "/estatico/htmlmixed.js\"></script>"
			+ "  <script src=\"" + PropertiesServiceController.getInstance().getProperty("url.base") + "/estatico/xml.js\"></script>"
			+ "</head>"
			+ "<body>"
			+ "<form><textarea id=\"code\" name=\"code\">\n"
			+ "${code}"
			...
			+ "<script>"
			+ "var mixedMode = { "
			+ "       name: \"htmlmixed\", lineNumbers: true, "
	 ...
	 */
	public HTMLCodeEditor(String editingCode) {
